...
<div class="ibody">
  ...
  <article>
    <h3 class="about_h">您现在的位置是：<a href="<%=path %>/admin/showBlog">首页</a>><a href="<%=path %>/admin/about">关于我</a></h3>
    <div class="about">
      <h2>Just about me</h2>
      <ul>
        <p>Quentin，男，一个80后草根女站长！09年入行，从业已经有三四年。从搬砖一样的生活方式换成了现在有“单”而居的日子。当然这个单不是单身的单，跟我的职业相比，爱情脱单并不是问题！虽然极尽苛刻的征婚条件但也远不及客户千奇百怪的要求。告别了朝九晚五，躲过了风吹日晒，虽然不再有阶梯式的工资，但是偶尔可以给自己放放假，挽着老公，一起轻装旅行。</p>
      ...
      <h2>About my blog</h2>
      <ul class="blog_a">
        <p>域  名：www.zhouxq.com 创建于2016年01月12日 <a href="http://www.net.cn/domain/" class="blog_link" target="_blank">注册域名</a><a class="blog_link" href="http://koubei.baidu.com/womc/s/www.yangqq.com" target="_blank">邀你点评</a></p>
        ...
        <p>程  序：Java</p>
        <p>微信公众号：quentin9898</p>
      </ul>
    </div>
  </article>
  <aside>
    <div class="avatar"><a href="<%=path %>/admin/about"><span>关于Quentin</span></a></div>
