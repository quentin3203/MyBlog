  ...
  <article>
	<div class="banner">
		...
		<div class="bloglist">
			...
			<form action="<%=path%>/admin/doUpdateBlog" method="post"
				class="dark-matter">
				<h1>把每天的收获都记录下来吧.</h1>
				<label> 
					<span>标题 :</span> 
					<input id="name" type="text" name="name" value="${blog.blogName}"/>
				</label> 
				<label> 
					<span> 图片 :</span> 
					<input type="file" name="picture" value="${blog.blogPicture }"/>
				</label> 
				<label> 
					<span>内容 :</span> 
					<textarea id="message" name="content">${blog.blogContent}</textarea>
				</label> 
				<label> 
					<span>类型 :</span>
				...
				<label> 
					<span>作者 :</span> 
					<input id="author" type="text" name="author" value="${blog.blogAuthor}"/>
				</label>
				<label>
