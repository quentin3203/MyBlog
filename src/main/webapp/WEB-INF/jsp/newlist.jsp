...
<div class="ibody">
  ...
  <article>
    <h2 class="about_h">您现在的位置是：<a href="<%=path %>/admin/showBlog">首页</a>><a href="<%=path %>/admin/newlist">慢生活</a></h2>
    <div class="bloglist">
      <div class="newblog">
        <ul>
        ...
        <figure><img src="<%=path %>/images/001.jpg" ></figure>
      ...
      <div class="newblog">
        ...
        <figure><img src="<%=path %>/images/005.jpg" ></figure>
        <div class="dateview">2014-04-08</div>
      </div>
      <div class="newblog">
        <ul>
        ...
        <figure><img src="<%=path %>/images/008.jpg" ></figure>
        <div class="dateview">2014-04-08</div>
      </div>
      <div class="newblog">
        <ul>
        ...
        <figure><img src="<%=path %>/images/002.jpg" ></figure>
        <div class="dateview">2014-04-08</div>
      </div>
      <div class="newblog">
        <ul>
        ...
        <figure><img src="<%=path %>/images/003.jpg" ></figure>
        <div class="dateview">2014-04-08</div>
      </div>
      <div class="newblog">
        <ul>
      ...
      <div class="newblog">
        ...
        <figure><img src="<%=path %>/images/004.jpg" ></figure>
        <div class="dateview">2014-04-08</div>
      </div>
      <div class="newblog">
        <ul>
        ...
        <figure><img src="<%=path %>/images/006.jpg" ></figure>
        <div class="dateview">2014-04-08</div>
      </div>
      <div class="newblog">
        <ul>
        ...
        <figure><img src="<%=path %>/images/007.jpg" ></figure>
        <div class="dateview">2014-04-08</div>
      </div>
    </div>
